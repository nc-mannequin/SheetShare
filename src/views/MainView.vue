...
import FavFileComponent from '../components/FavFileComponent.vue';
                    ...
                    <div class="d-grid gap-2 text-center mt-5 mx-4">
                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop-logout">
                          <div class="row justify-content-center align-items-center g-2">
                            ...
                            <div class="col-md-9 text-center"><span>Logout</span></div>
                          </div>
                        </button>
                    </div>
                  ...
                  <div class="mt-4">
                    ...
                    <div class="container mt-4">
                        <div v-if="fav_materials.length > 0" class="row row-cols-1 row-cols-md-2 g-4">
                          <FavFileComponent v-for="material, i in fav_materials" :material="material" :key="i"></FavFileComponent>
                        </div>
                        <div v-else class="row ">
