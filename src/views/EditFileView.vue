...
import { collection, onSnapshot, doc, getFirestore, updateDoc, Timestamp, getDoc } from 'firebase/firestore'
    ...
    <section class="py-4 mt-5">
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row mt-3">
                        <h2><span class="underline"><span class="material-symbols-outlined mx-2 thispage">library_books</span>Edit File</span></h2>
                    </div>
                    ...
                    <h3>Subject:
                        <input class="form-control mb-3" list="subjectdatalistOptions" id="subjectDataList" :placeholder=file.subject v-model="file.subject">
                    ...
                    <h3>Level:
                        <input class="form-control mb-3" list="leveldatalistOptions" id="levelDataList" :placeholder=file.level v-model="file.level">
                    ...
                    <h3>Decription</h3>
                    <textarea class="w-100" rows="3" :placeholder=file.description v-model="file.description"></textarea><br>
